 ...
 */
    ...
    public:
                        ...
                        bool tx_prove = false)
        {
            ...
            {
                return string("XDC address not provided!");
            }
...
*/
     ...
     */
                     ...
                     bool tx_prove = false)
        {
            ...
            {
                j_response["status"]  = "error";
                j_response["message"] = "Cant parse xdc address.";
                return j_response;
        ...
        json_networkinfo()
        {
            ...
            {
                j_response["status"]  = "error";
                j_response["message"] = "Cant get xdc network info";
                return j_response;
            }
        ...
        */
        ...
        json_version()
        {
            ...
            j_data = json {
                    ...
                    {"monero_version_full" , string {XDC_VERSION_FULL}},
